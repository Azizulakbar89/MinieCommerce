...
class ShopServiceProvider extends ServiceProvider
{
    ...
    public function registerTranslations(): void
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(base_path('Modules/Shop/lang'), $this->nameLower);
            $this->loadJsonTranslationsFrom(base_path('Modules/Shop/lang'));
        }
    }
    ...
    protected function registerConfig(): void
    {
        ...
        $configPath = base_path('Modules/Shop/' . $relativeConfigPath);
